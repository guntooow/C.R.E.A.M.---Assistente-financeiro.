...
const Windowinfo = ({ name, description, price, date, type, setTotalDevido }) => {
    ...
    return (
        <div id="mainContent" className="transition-all transform text-zinc-50 border-[0.1rem] border-zinc-50 p-6 rounded-lg flex flex-col w-96 gap-1 relative">
            <div className="flex justify-between">
                <h1 id="name" className="text-zinc-50 text-2xl font-semibold overflow-ellipsis">{name}</h1>
                <h1 className="font-bold">{type}</h1>
            </div>
            <p className="text-zinc-200 text-sm font-light overflow-ellipsis">{description}</p>
